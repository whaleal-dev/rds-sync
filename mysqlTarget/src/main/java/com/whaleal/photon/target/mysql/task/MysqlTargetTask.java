...
public class MysqlTargetTask extends AbstractTargetTask {
    ...
    public MysqlTargetTask(ProgramInfo programInfo, MemoryCache memoryCache) {
        ...
        this.connection = MySqlConnection.getConnection(getProcNameAndBatchNoAndTargetDsName());
    ...
    public void applyData() {
        while (true) {
            try {
                if (AbstractTargetTask.getIsStopFlagOfTarget(getProcNameAndBatchNo())) {
                    break;
                }
