...
import exception.RdbmsException;
...
//        //ob10的处理
//        if (url.startsWith(com.whaleal.mysql2mongodb.utils.Constant.OB10_SPLIT_STRING)) {
...
//        }
    ...
    public static boolean isOracleMaster(final String url, final String user, final String pass) {
        try {
            return RetryUtil.executeWithRetry(new Callable<Boolean>() {
                ...
                public Boolean call() throws Exception {
                    ...
                    try {
                        ...
                        throw PhotonTException.asDataXException(DBUtilErrorCode.RS_ASYNC_ERROR,
            ...
            throw PhotonTException.asDataXException(DBUtilErrorCode.CONN_DB_ERROR,
...
//            throw PhotonTException.asDataXException(DBUtilErrorCode.CONF_ERROR,
