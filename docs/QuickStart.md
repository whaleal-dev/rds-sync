...
本仓库正在演进为嵌入式 SDK，启动方式以架构文档为准。当前是 **P0 架构契约**。
...
| 在本仓 | 不在本仓 |
|--------|----------|
| MySQL / Oracle / PostgreSQL 全量源（代码在，**未接**产品 SPI） | MongoDB / DocumentDB → 见 [mongo-sync](https://github.com/whaleal-dev/mongo-sync) |
